...
import Data.AddressBook (Address(..), Person(..), PhoneNumber(..), examplePerson, person, address, phoneNumber, PhoneType(..))
...
scottSedgwick :: Person
scottSedgwick =
  person "Scott" "Sedgwick"
         (address "42 Hallam Ave" "Lane Cove West" "NSW")
         [ phoneNumber HomePhone "02-9418-7603"
         , phoneNumber CellPhone "04-1811-0370"
         ]
    ...
    D.div [ P.className "container" ]
          ...
          , D.div [ P.className "row" ]
                  [ D.form [ P.className "form-horizontal" ] $
                           ...
                           , D.div [ P.className "form-group" ] 
                             [ D.label [ P.className "col-sm-2 control-label" ] [ D.text "" ]
                             , D.div [ P.className "col-sm-3" ]
                               [ D.button [ P.onClick \_ -> log "Clicked me!" ] [ D.text "OK :)" ]
                               ]
                             ]
                  ]
          ]
